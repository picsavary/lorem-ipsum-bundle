...
class KnpUIpsum
{
    ...
    public function __construct(
        array $wordProviders,
        // iterable $wordProviders,
        // in case of use of argument type "tagged" in services.xml, for 3.4 or hiegher SF versions
    ...
    public function getSentences( $count = 1): string // int
    {
